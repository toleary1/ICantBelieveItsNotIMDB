...
$castsql = "SELECT Actor.actorID, actorFirstName, actorLastName, Cast.Role, Cast.movieID FROM Actor INNER JOIN Cast on Actor.actorID = Cast.actorID WHERE movieID = '$movieid'";
